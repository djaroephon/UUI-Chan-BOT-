// events/messageCreate.js (Versi Cerdas dengan Role)
...
module.exports = {
    ...
    async execute(message) {
        ...
        try {
            const finalPrompt = `${personalityPrompt} Panggil dia dengan sebutan "${targetName}". Pertanyaan dari ${targetName}: "${userPrompt}"`;
