...
const jadwalKuliah = {
    ...
    1: [
        {mk:'Statistika', jam: '10:00 - 12:00', dosen: 'Dr. Mutiawati, S.Pd., M.Pd', klm: 'Ibuk' },
    ], // Senin
    2: [ // Selasa
         { mk: 'Pemograman Berbasis Platform', jam: '08:00 - 11:00', dosen: 'Mahendar Dwi Payana, S.ST., MT', klm: 'bapak' },
        { mk: 'Datawarehouse', jam: '14:00 - 17:00', dosen: 'M. Bayu Wibawa, S.Kom., MMSI.', klm: 'bapak' }
    ],
    3: [ // Rabu
        { mk: 'Cyber Security', jam: '08:00 - 11:00', dosen: 'Rizka Albar, S.Kom.,MT', klm: 'bapak' },
    ],
    4: [ // Kamis
        { mk: 'Etika dan Berprofesi', jam: '14:00 - 17:00', dosen: 'Armia, ST.,M.Sc', klm: 'Bapak' }
    ],
    5: [
        {mk: 'Analisis dan Desain Perangkat Lunak', jam: '08:00 - 11:00', dosen: 'Miftahul Jannah, S.Kom., M.Pd', klm: 'Ibuk' },
        {mk: 'Keamanan dan Informasi', jam: '14:00 - 17:00', dosen: 'Rizka Albar, S.Kom., MT', klm: 'bapak' }
    ],
    6: "Sabtu Libur! Saatnya main game atau nonton anime." 
};
// ---------------------------------
